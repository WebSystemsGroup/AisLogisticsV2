...
namespace AisLogistics.App.Models.AdditionalForms.Regional
{
    ...
    public class Service27_2Model : AbstractAdditionalFormModel
    {
        ...
        /// <summary>
        /// наименование органа государственная регистрация перемены имени
        /// </summary>
        ...
        /// ФИО 
        /// </summary>
        public string Fio_The { get; set; }

        /// <summary>
        /// ФИО после перемены имени присвоены
        /// </summary>
        public string Fio_End { get; set; }

namespace AisLogistics.App.Models.AdditionalForms.Regional
{
    ...
    public class Service25Model : AbstractAdditionalFormModel
    {
        ...
        /// <summary>
        /// заключения брака назначена на
        /// </summary>
        public DateTime? Date_Termination { get; set; }

        /// <summary>
        ///Дата переноса  заключения брака назначена на
        /// </summary>
        ...
        /// </summary>
        public string Int_Child { get; set; }
        ...
        public class Person
        {
            ...
            /// <summary>
            /// после заключения брака присвоить фамилии
            /// </summary>
            ...
            /// <summary>
            /// Семейное положение довступления в брак
            /// </summary>
            ...
            /// </summary>
            public string Doc_Termination { get; set; }
            ...
            public class other
            {
                ...
                /// Документ подтверждающий прекращение предыдущего брака
                /// </summary>
                public string Doc_Termination_Un { get; set; }

...
namespace AisLogistics.App.Controllers
{
    public class ReestrUnclaimedDocumentsController : AbstractController
    {
        ...
        public ReestrUnclaimedDocumentsController(IReestrUnclaimedDocuments caseReest, IReferencesService referencesService,
            EmployeeManager employeeManager, ILogger<ReestrUnclaimedDocumentsController> logger, IConfiguration configuration, ICaseService caseService) : base(employeeManager)
        {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var model = await _caseReestr.GetReestrUnclaimedDocumentsV2(officeId);

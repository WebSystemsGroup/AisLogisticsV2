...
{
    [HtmlTargetElement("calendar", Attributes = ForAttributeName)]
    [HtmlTargetElement("calendar", Attributes = AccessAttributeName)]
    public class CalendarTagHelper : TagHelper
    {
        private IActionContextAccessor _actionContextAccessor;
        public CalendarTagHelper(IActionContextAccessor actionContextAccessor)
        {
        ...
        public string AccessKeyName { get; set; } = AccessKeyNames.ReferenceCalendar;
        ...
        public override void Process(TagHelperContext context, TagHelperOutput output)
        {
                ...
                !string.IsNullOrEmpty(For.TableName))
            {
                htmlAttributes = new Dictionary<string, object>(StringComparer.OrdinalIgnoreCase)
                {
                    { "name", For.TableName },
                    { "id", For.TableName },
                    { "data-action-get", For.TableMethodAction },
                };
            }
